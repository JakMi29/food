...
import Food_app.api.dto.ExceptionMessage;
...
public class GlobalExceptionRestHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        log.error("Exception: ID={}, HttpStatus={}", errorMessage, statusCode, exception);
        return super.handleExceptionInternal(exception, ExceptionMessage.of(errorMessage), headers, statusCode, request);
    }
